  ...
  var require_bliss = __commonJS({
    "node_modules/blissfuljs/bliss.js"() {
      (function() {
        ...
        extend($, {
          ...
          value: function(obj) {
            ...
            return $.$(arguments).slice(+hasRoot).reduce(function(obj2, property) {
          ...
          bind: overload(function(types, options) {
            ...
            types.trim().split(/\s+/).forEach(function(type2) {
              ...
              if (listeners[type2].filter(function(l) {
                ...
                listeners[type2].push($.extend({ className }, options));
              }
              $.original.addEventListener.call(this, type2, options.callback, options);
            }, this);
            ...
            (types || "").trim().split(/\s+/).forEach(function(type2) {
              ...
              if (!listeners) {
                if (type2 && options.callback) {
                  return $.original.removeEventListener.call(this, type2, options.callback, options.capture);
                }
                return;
              }
              ...
              if ($.listeners) {
                ...
                for (var type2 in listeners) {
                  listeners[type2].forEach(function(l) {
                    $.bind(me, type2, l.callback, l.capture);
                  });
                }
              }
            ...
            if (on.$) {
              ...
              if (on.array || on.element) {
                $[method] = function() {
                  ...
                  return $[Type].prototype[method].apply({ subject }, args);
                };
              }
            }
          }
      ...
      (function($) {
        ...
        Object.defineProperty(Node.prototype, _2, {
          get: function getter() {
            Object.defineProperty(Node.prototype, _2, {
              get: void 0
            });
        ...
        Object.defineProperty(Array.prototype, _2, {
          get: function() {
            Object.defineProperty(this, _2, {
